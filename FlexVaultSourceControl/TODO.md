...
- [x] **Active Unsubmitted Draft Handling in File History**:
  - `QueryFlexVaultFileHistoryDetails` queries active local draft revisions via `fxv changeinfo` (using `branch.base.draft` ID) while gracefully handling pruned drafts.
